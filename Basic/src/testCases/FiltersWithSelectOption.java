...
public class FiltersWithSelectOption {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		Thread.sleep(2000);
		WebElement source = driver.findElement(By.xpath("//span[@id='select2-chosen-1']"));
		Select assetdw = new Select(source);
		assetdw.selectByIndex(3);
